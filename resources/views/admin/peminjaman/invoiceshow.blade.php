            ...
            <div class="invoice p-3 mb-3">
                ...
                <div class="row">
                  <div class="col-12">
                    <h4>
                      ...
                      <small class="float-right">Date: {{Fungsi::tanggalindo($datapinjam->tgl_pinjam)}}</small>
                    </h4>
                  </div>
                  <!-- /.col -->
                </div>
                ...
                <div class="row">
                  <div class="col-12 table-responsive">
                    <table class="table table-striped">
                      ...
                      <tr>
                        @php
                        $jmldatapinjam=DB::table('peminjamandetail')->where('kodetrans',$datapinjam->kodetrans)->where('buku_kode',$data->buku_kode)->orderBy('created_at', 'desc')->count();
                ...
                <div class="row no-print">
                  <div class="col-12">
                    ...
                    <a type="button" class="btn btn-default float-right" style="margin-right: 5px;" href="{{url('/invoice/'.$datapinjam->kodetrans)}}"><i class="fas fa-print"></i> Show
                    </a>
