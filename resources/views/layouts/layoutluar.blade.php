        ...
        'shadow-t-lg md:shadow-lg bg-white dark:bg-gray-700': scrollingUp }">
                <div class="relative flex flex-row-reverse items-center justify-between p-4 mx-auto bg-white max-w-7xl md:flex-row md:h-24 md:bg-transparent dark:bg-gray-700 md:dark:bg-transparent"
                    ...
                    <a href="#" class="inline-block rounded-md">
                        <span class="sr-only">{{Fungsi::aplikasijudul()}}</span>
                        <img src="{{url('/assets/upload/logoyayasan.png')}}" alt="logoyayasan"  class="w-10 h-auto  md:w-12">
                        {{-- <svg aria-hidden="true" class="w-10 h-auto text-purple-500 md:w-12" viewBox="0 0 101 100"
                                ...
                                <a :href="link.link" @mouseenter="handelMouseEnter($el)"
                                    ...
                                    <div class="overflow-hidden">
                                        ...
                                        <div aria-hidden="true" x-ref="underlineLink"
                                            class="underline-link h-0.5 w-full bg-purple-600 translate-x-[102%]"></div>
                                    </div>
                                </a>
                            </li>
                        </template>
            ...
            <main>
                <h1 class="sr-only">App</h1>

                <script>
                    const carouselText = [
                  {text: " PERPUSTAKAAN", color: "red"},
                  {text: " PERPUSTAKAAN", color: "orange"},
                  {text: " PERPUSTAKAAN", color: "green"}
                ]
