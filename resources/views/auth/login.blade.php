            ...
            <div class="flex justify-center p-4 px-3 py-10">
                <div class="w-full max-w-lg">
                    <div class="bg-white rounded shadow shadow-drop-center">
                        <div class="py-4 text-s tracking-wider text-center text-gray-700 border-b">
                            ...
                            <div class="px-8 pt-6 pb-8 mb-4 bg-white rounded shadow-md">
                                <div class="mb-4">
                                    ...
                                    <input
                                        ...
                                        id="inline-full-name" type="text" placeholder="Username / Email " name="identity"
                                        required>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input
                                        class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-500 leading-tight focus:outline-none focus:bg-white focus:border-purple-500 search"
                                        id="inline-full-name" placeholder="Password" name="password" type="password"
                                        required>
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <button
                                        class="px-4 py-2 font-semibold text-white bg-transparent border border-white rounded hover:bg-white active:bg-white hover:text-white hover:border-transparent focus:outline-none focus:shadow-outline"
                                        id="clear">
                                    </button>
