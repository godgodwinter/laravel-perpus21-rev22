            ...
            <div class="flex justify-center p-4 px-3 py-10">
                <div class="w-full max-w-lg">
                    <div class="bg-white rounded shadow shadow-drop-center">
                        ...
                        <form action="pengunjung/proses" class="px-8 pt-6 pb-8 mb-4 bg-white rounded shadow-md" method="GET"
                            ...
                            <div class="mb-4">
                                ...
                                <input
                                    class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-500 leading-tight focus:outline-none focus:bg-white focus:border-purple-500 nama"
                                    id="inline-full-name" type="date" placeholder="" name="tgl" required
                                    value="{{ $tgl }}">
                                @error('nama')
                                    <label class="block mb-2 font-bold text-red-300 text-sm" for="pair">
                                        {{ $message }}
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <button
                                    class="px-4 py-2 font-semibold text-yellow-700 bg-transparent border border-yellow-500 rounded hover:bg-yellow-600 active:bg-yellow-700 hover:text-white hover:border-transparent focus:outline-none focus:shadow-outline transform hover:scale-150 transition duration-500 ease-in-out"
                                    href="#" id="clear"> Clear
                                </button>
