                        ...
                        <div class="px-8 pt-6 pb-8 mb-4 bg-white rounded shadow-md">
                            <div class="mb-4">
                                ...
                                <input
                                    ...
                                    id="inline-full-name" type="text" placeholder="Cari Buku . . . " name="cari">

                            </div>
                            <div class="mb-4">
                                <label class="block mb-2 font-bold text-red-300 text-sm" for="pair">
                                    Masukkan kata kunci, kemudian geser ke bawah untuk hasil pencarian
                                </label>
                            </div>
                            <div class="flex items-center justify-between">
                                ...
                                <button
                                    ...
                                    href="#" id="clear"> Hapus Kata Kunci
                                </button>
